...
locals {
  ...
  #                            env is                "dev"                                    env is           "test"                                  env is                 "prod"                 else "Dev"
  sa_name = var.input_environment == "Development" ? "s118d01dfbackendsa" : var.input_environment == "Test" ? "s118d01tfbackendsa" : var.input_environment == "Production" ? "s118d01pfbackendsa" : "s118d01dfbackendsa"
  #                            env is                  "dev"                                  env is           "test"                                  env is Production                 region is north eur            "prod north Europe"    else "prod West Europe"     else "Dev"
  cont_name = var.input_environment == "Development" ? "s118d01devtfstate" : var.input_environment == "Test" ? "s118t01testtfstate" : var.input_environment == "Production" ? (var.input_environment == "northeurope" ? "s118p01northprodtfstate" : "s118p01westprodtfstate") : "s118d01devtfstate"
