...
locals {
  ...
  container_version = var.input_environment == "Development" ? "20210331.2" : var.input_environment == "Test" ? "20210331.2" : var.input_environment == "Production" ? "20210201.3" : "20210201.3"
}
